...
\subsection{Initialization of Grouper} \label{subsection:grouper_initilaization}
...
\subsection{Object Deletion} \label{subsection:object_deletion}
...
\subsection{Receiving messages from Untrusted Servers} \label{subsection:receiving_message}
...
\subsection{Sending Confirm Messages} \label{subsection:sending_confirm_messages}
