...
\begin{table*}[t]
	\centering
	\caption{The API of the sync plug-in layer}
	\label{my-label}
	\begin{tabular}{ll}
		\hline
		\textbf{Method} & \textbf{Description} \\ \hline
...
For an update message or a delete message, Grouper invokes the method $sync()$ of sync plug-in layer to put the object into the persistent store.
