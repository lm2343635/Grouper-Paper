...
Chapter 1 points out the problems of the mobile applications using the central servers to store user data.
...
Chapter 3 proposes the threat model of Grouper.
...
Chapter 4 presents the design of Grouper.
...
Chapter 5 involves the implementation details of Grouper using the Objective-C language and the Java language.
...
Chapter 7 gives a evaluation of Grouper and discusses its scalability.
