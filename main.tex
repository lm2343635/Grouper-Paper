...
If some one attacks the HTTP connection and gets some shares, he can try to recover these shares and may get the original data.
...
At last, server are isolated from one another and managed by independent providers.
...
In Grouper, we use the secret sharing scheme to protect our user data. 
