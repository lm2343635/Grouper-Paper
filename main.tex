...
Concretely, the basic function of target applications is to share some light-weight informations among members in a small groups.
Now, Grouper support to exchange object among devices.
...
\begin{itemize}
	...
	\setlength{\parskip}{0pt}
	\setlength{\parsep}{0pt}
	\item \emph{Data Synchronization.} If an user updates an object in his device, the mirrors of this object in other devices are updated.
	\item \emph{Group management.} A group owner can create a group and invite other members to his group.
\end{itemize}
