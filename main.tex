...
We will describe reliable messaging in chapter 3.4.
...
\section{Grouper Message Protocol}
...
To extend the application, we invoke the $grouper.setup()$ method introduced in Table 4.1 to initialize Grouper in the method $- (BOOL)application: didFinishLaunchingWithOptions:$ of the AppDelegate at first.
...
To share this record with other group members, Account Book invokes the $sender.update()$ method of Grouper to share this record with other group members.
...
\newblock Reading, Massachusetts: Addison-Wesley, 1984.

\bibitem{Usersguide}
Lessie Lamport.
\newblock A Document Preparation System \LaTeX\ User's Guide \& Reference Manual (second edition).
