...
We describe the implementation of the client framework in Section \ref{section:client_framework}, the implementation of the Web service in Section \ref{section:web_service}, and the demo applications in Section \ref{section:application}.
