...
\begin{table*}[t]
	...
	\begin{tabular}{ll}
		...
		\begin{tabular}{@{}l@{}}
			...
			need not to delete the object and save to persistent store before invoking delete \\ method. Once you delete it, Grouper cannot create Grouper message from this \\ 
