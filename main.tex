...
% Add screenshoot for the method openDeviceBroswerIn here. 
...
\section{Application Development} \label{section:application}
...
In this section, we show how to extend a standalone application into a data sharing application using Grouper.
...
\begin{figure}[t]
	...
	\caption{Adding and deleting a record in the Account Book demo application.}
...
Developers need not to delete the record in the local persistent store using the API of Core Data before invoking the method $grouper.sender.delete()$,  like the method $sender.update()$ does, because Grouper deletes the record in the local persistent store before creating a delete message.
